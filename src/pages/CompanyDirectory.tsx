  ...
  <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col">
    ...
    <main className="flex-1 w-full max-w-4xl mx-auto px-4 py-10">
      ...
      <p className="text-slate-400 text-lg mb-4 text-center">
        Discover top infrastructure companies, filter by sector, region, and more.
      </p>
      <div className="rounded-xl bg-slate-900/80 p-6 text-slate-300 text-center shadow-lg">
        <span className="text-yellow-400 font-medium">Company directory dashboard coming soon!</span>
      </div>
    </main>
    <Footer />
  </div>
